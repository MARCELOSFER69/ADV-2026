...
import { cleanFinancialTitle } from '../../utils/dateUtils';
                    ...
                    return (
                        <div key={item.id} className="flex items-center justify-between p-3 rounded-xl bg-black/20 border border-white/5 hover:border-emerald-500/30 transition-all group">
                            <div className="min-w-0 flex-1">
                                <h4 className="text-xs font-bold text-zinc-200 truncate group-hover:text-white">{cleanFinancialTitle(item.titulo)}</h4>
