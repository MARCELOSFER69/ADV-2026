...
const Sidebar: React.FC = () => {
  ...
  const caseItems = [
    { id: 'cases-judicial', label: 'Judicial', icon: Gavel },
    { id: 'cases-administrative', label: 'Administrativo', icon: FileText },
    { id: 'cases-insurance', label: 'Seguro Defeso', icon: Shield },
  ];

  const toolItems = [
    { id: 'cnis', label: 'Leitor CNIS', icon: FileScan },
    { id: 'gps-calculator', label: 'Calculadora GPS', icon: Calculator },
    { id: 'document-builder', label: 'Criador Modelos', icon: Briefcase },
  ];
