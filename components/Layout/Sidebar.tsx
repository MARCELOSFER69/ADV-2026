    ...
    return (
        <>
            ...
            <div className="hidden md:block w-[70px] h-screen shrink-0 relative z-50 group/sidebar-wrapper">
                ...
                <aside
                    className="flex flex-col w-[70px] hover:w-64 bg-navy-950/95 backdrop-blur-xl border-r border-white/5 h-screen absolute top-0 left-0 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group z-50 overflow-hidden shadow-2xl hover:shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)]"
                >
                            ...
                            {BRAND_CONFIG.logoBase64 ? (
                                <div className="relative w-full h-full flex items-center justify-center">
                                    <img
                                        ...
                                        className="max-h-10 group-hover:max-h-12 w-auto object-contain transition-all duration-500 rounded-xl"
                                        style={{
                                ...
                                <div className="w-10 h-10 border-2 border-gold-500 transform rotate-45 flex items-center justify-center rounded-xl bg-navy-900/50 backdrop-blur-sm">
                                ...
                                <AnimatePresence>
                                    {isCasesOpen && (
                                        <motion.div
                                            ...
                                            className="overflow-hidden space-y-1 bg-navy-950/50"
                                        >
                    ...
                    <div className="h-20 border-t border-white/5 shrink-0 bg-navy-950/50 backdrop-blur-md flex items-center overflow-hidden">
                        ...
                        <div className="min-w-[70px] flex items-center justify-center">
                            <button
                                ...
                                className="w-10 h-10 rounded-full bg-navy-800/50 border border-white/10 flex items-center justify-center text-xs font-bold text-gold-500 overflow-hidden hover:border-gold-500 transition-all shadow-sm group-hover:scale-105"
                                title="Editar Perfil"
                            >
                                {user?.avatar ? (
                        ...
                        <div className="whitespace-nowrap overflow-hidden w-0 opacity-0 group-hover:w-auto group-hover:opacity-100 transition-all duration-500 pr-3">
                            <button
                                onClick={logout}
                                className="text-slate-500 hover:text-red-500 transition-colors p-2 hover:bg-white/5 rounded-lg"
                                title="Sair"
                            >
                                <LogOut size={18} />
                            </button>
