...
interface CaseInfoTabProps {
    ...
    // Edição vinda do Modal pai
    localCaseData: Case;
    hasChanges: boolean;
    onLocalChange: (updates: Partial<Case>) => void;
                                ...
                                <div>
                                    <CustomSelect
                                        ...
                                        onChange={(val) => {
                                            ...
                                            else onLocalChange({ tipo: val as any, modalidade: undefined });
                                        }}
                                    />
                                    {showNewTypeInput && (
                                ...
                                <div>
                                    <CustomSelect
                                        ...
                                        onChange={(val) => {
                                            ...
                                            else onLocalChange({ modalidade: val });
                                        }}
                        ...
                        <div className="md:col-span-2">
                            ...
                            {isEditMode ? (
                                <input
                                    ...
                                    onChange={e => onLocalChange({ numero_processo: e.target.value })} // TODO: Add mask
                        ...
                        <div>
                            ...
                            {isEditMode ? (
                                <CustomSelect
                                    ...
                                    onChange={val => onLocalChange({ status: val as any })}
                                />
                            ) : (
                        ...
                        <div>
                            ...
                            {isEditMode ? (
                                <input
                                    ...
                                    onChange={e => onLocalChange({ valor_causa: parseCurrencyToNumber(e.target.value) })}
                                />
                            ) : (
