        ...
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#18181b] p-4 rounded-xl border border-white/5">
                    <div className="flex items-center gap-3 text-slate-500 mb-2 text-[10px] uppercase tracking-wider font-bold">
            ...
            <div className="relative">
                ...
                {fetching ? (
                    ...
                    <div className="bg-[#18181b] border border-white/5 rounded-xl p-8 text-center">
                        ...
                        <p className="text-slate-500 text-sm">Nenhum histórico encontrado para este processo.</p>
                    </div>
                ) : (
                    <div className="space-y-4">
                        {history.map((item, index) => (
                            <div key={item.id} className="relative pl-8 pb-4 last:pb-0">
                                ...
                                <div className="absolute left-0 top-1.5 w-6 h-6 rounded-full bg-[#131418] border border-gold-500/50 flex items-center justify-center z-10 shadow-lg ring-4 ring-[#131418]">
                                    <div className="w-2 h-2 rounded-full bg-gold-500"></div>
                                </div>

                                <div className="bg-[#18181b] border border-white/5 rounded-xl p-4 hover:border-gold-500/30 transition-colors shadow-sm">
                                    ...
                                    <div className="text-zinc-300 text-sm mb-2 opacity-90">
