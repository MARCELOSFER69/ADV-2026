      ...
      if (printWindow) {
          ...
          const htmlContent = `
            <html>
              ...
              <style>body{font-family:'Times New Roman';padding:40px}.header{text-align:center;border-bottom:2px solid #000;padding-bottom:20px}.title{font-size:24px;font-weight:bold;text-transform:uppercase}.table{width:100%;border-collapse:collapse;margin:20px 0}.table td{border:1px solid #ddd;padding:8px}.total{text-align:right;font-weight:bold;font-size:18px}.signatures{margin-top:80px;display:flex;justify-content:space-between}.sig-line{width:45%;border-top:1px solid #000;text-align:center;padding-top:5px}</style>
              </head>
              <body>
