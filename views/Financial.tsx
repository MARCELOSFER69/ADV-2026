...
const Financial: React.FC = () => {
    const { clients, financial, showToast, officeExpenses, setCurrentView, currentView, setCaseToView, deleteFinancialRecord, commissionReceipts, confirmReceiptSignature, deleteCommissionReceipt, uploadReceiptFile, addFinancialRecord, setClientToView } = useApp();
