...
const Expertise: React.FC = () => {
    const { events, clients, setClientToView, setCaseToView, setCurrentView, updateEvent, deleteEvent, showToast } = useApp();
    ...
    React.useEffect(() => {
        console.log('🔍 [ExpertiseView] Events:', events);
        console.log('🔍 [ExpertiseView] Clients:', clients);
    }, [events, clients]);
