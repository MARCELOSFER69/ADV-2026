                            ...
                            <div className="p-6 border-t border-zinc-800 bg-[#0a0a0c] grid grid-cols-1 md:grid-cols-3 gap-8 animate-in slide-in-from-top-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center p-3 bg-zinc-900/50 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                                            ...
                                            <ToggleSwitch checked={u.access_dashboard} onChange={() => handleTogglePermission(u.id, 'access_dashboard', !!u.access_dashboard)} />
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-zinc-900/50 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                                            <span className="text-sm text-zinc-300 flex items-center gap-2"><Users size={14} /> Clientes</span>
                                            <ToggleSwitch checked={u.access_clients} onChange={() => handleTogglePermission(u.id, 'access_clients', !!u.access_clients)} colorClass="peer-checked:bg-blue-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-zinc-900/50 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                                            ...
                                            <ToggleSwitch checked={u.access_retirements} onChange={() => handleTogglePermission(u.id, 'access_retirements', !!u.access_retirements)} colorClass="peer-checked:bg-gold-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-zinc-900/50 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                                            <span className="text-sm text-zinc-300 flex items-center gap-2"><User size={14} className="text-purple-500" /> Aba Pessoal</span>
                                            <ToggleSwitch checked={u.access_personal} onChange={() => handleTogglePermission(u.id, 'access_personal', !!u.access_personal)} colorClass="peer-checked:bg-purple-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-3 bg-zinc-900/50 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors">
                                            ...
                                            <ToggleSwitch checked={u.access_whatsapp} onChange={() => handleTogglePermission(u.id, 'access_whatsapp', !!u.access_whatsapp)} colorClass="peer-checked:bg-emerald-600" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center mb-2 px-1">
                                        ...
                                        <ToggleSwitch checked={u.access_cases} onChange={() => handleTogglePermission(u.id, 'access_cases', !!u.access_cases)} />
                                    </div>
                                    ...
                                    <div className={`space-y-2 pl-2 border-l-2 border-zinc-800 ${!u.access_cases && u.role !== 'admin' ? 'opacity-50 pointer-events-none' : ''}`}>
                                        <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50 group/prop">
                                            ...
                                            <ToggleSwitch checked={u.access_cases_judicial} onChange={() => handleTogglePermission(u.id, 'access_cases_judicial', !!u.access_cases_judicial)} colorClass="peer-checked:bg-yellow-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50 group/prop">
                                            <span className="text-sm text-zinc-300">Administrativo (INSS)</span>
                                            <ToggleSwitch checked={u.access_cases_administrative} onChange={() => handleTogglePermission(u.id, 'access_cases_administrative', !!u.access_cases_administrative)} colorClass="peer-checked:bg-yellow-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50 group/prop">
                                            <span className="text-sm text-zinc-300">Seguro Defeso</span>
                                            <ToggleSwitch checked={u.access_cases_insurance} onChange={() => handleTogglePermission(u.id, 'access_cases_insurance', !!u.access_cases_insurance)} colorClass="peer-checked:bg-yellow-600" />
                                        </div>
                                        ...
                                        <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50 group/prop">
                                            ...
                                            <ToggleSwitch checked={u.access_expertise} onChange={() => handleTogglePermission(u.id, 'access_expertise', !!u.access_expertise)} colorClass="peer-checked:bg-yellow-600" />
                                        </div>
                                        <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50 group/prop">
                                            ...
                                            <ToggleSwitch checked={u.access_events} onChange={() => handleTogglePermission(u.id, 'access_events', !!u.access_events)} colorClass="peer-checked:bg-yellow-600" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className={`space-y-2 pl-2 border-l-2 border-zinc-800 ${!u.access_financial && u.role !== 'admin' ? 'opacity-50 pointer-events-none' : ''}`}>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                ...
                                                <ToggleSwitch checked={u.access_financial} onChange={() => handleTogglePermission(u.id, 'access_financial', !!u.access_financial)} colorClass="peer-checked:bg-emerald-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                <span className="text-sm text-zinc-300 flex items-center gap-2"><HandCoins size={14} className="text-emerald-500" /> Comissões</span>
                                                <ToggleSwitch checked={u.access_commissions} onChange={() => handleTogglePermission(u.id, 'access_commissions', !!u.access_commissions)} colorClass="peer-checked:bg-emerald-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                ...
                                                <ToggleSwitch checked={u.access_office_expenses} onChange={() => handleTogglePermission(u.id, 'access_office_expenses', !!u.access_office_expenses)} colorClass="peer-checked:bg-emerald-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                ...
                                                <ToggleSwitch checked={u.access_financial_calendar} onChange={() => handleTogglePermission(u.id, 'access_financial_calendar', !!u.access_financial_calendar)} colorClass="peer-checked:bg-emerald-600" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className={`space-y-2 pl-2 border-l-2 border-zinc-800 ${!u.access_tools && u.role !== 'admin' ? 'opacity-50 pointer-events-none' : ''}`}>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                ...
                                                <ToggleSwitch checked={u.access_tool_cnis} onChange={() => handleTogglePermission(u.id, 'access_tool_cnis', !!u.access_tool_cnis)} colorClass="peer-checked:bg-pink-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                <span className="text-sm text-zinc-300 flex items-center gap-2"><Calculator size={14} className="text-pink-500" /> Calc. GPS</span>
                                                <ToggleSwitch checked={u.access_tool_gps} onChange={() => handleTogglePermission(u.id, 'access_tool_gps', !!u.access_tool_gps)} colorClass="peer-checked:bg-pink-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
                                                <span className="text-sm text-zinc-300 flex items-center gap-2"><Briefcase size={14} className="text-pink-500" /> Docs Builder</span>
                                                <ToggleSwitch checked={u.access_tool_docs} onChange={() => handleTogglePermission(u.id, 'access_tool_docs', !!u.access_tool_docs)} colorClass="peer-checked:bg-pink-600" />
                                            </div>
                                            <div className="flex justify-between items-center p-2 rounded hover:bg-zinc-900/50">
