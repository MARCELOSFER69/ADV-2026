-- SCRIPT PARA RECRIAR A VIEW E ADICIONAR A COLUNA TENANT_ID NELA
-- Como adicionamos a coluna tenant_id na tabela clients, precisamos recriar a View
-- para que o banco de dados passe a enxergar essa nova coluna nas buscas de clientes.
